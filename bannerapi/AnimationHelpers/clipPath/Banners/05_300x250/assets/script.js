...
$(function(){
	 $(document).on("click","#exit_click_area",function(){
		mraid.open(Adform.getClickURL('clickTAG1'));
 	});
	...
	function animate_banner(){
	    ...
	    mytl
	    	.from(text2_1, 0.8, {delay:0 , clip:clip3_start, ease:Power0.easeNone}, "scene1")
	    	.from(cta, 0.5, {opacity:0, ease:Power2.easeOut},"+=0.5")
	    	.to([text2_1],0.5,{opacity:0, ease:Power2.easeOut}, "+=2")
	    	.from(text1_1, 0.8, {delay:0 , clip:clip1_start, ease:Power0.easeNone},"scene2")
	    	.from(text1_2, 0.8, {delay:0 , clip:clip2_start, ease:Power0.easeNone},"scene2+=0.8")
	...
	// if(mraid.getState() === 'loading') {
         // mraid.addEventListener('ready',  setup); 
    // }else { 
        setup();
    // }
});