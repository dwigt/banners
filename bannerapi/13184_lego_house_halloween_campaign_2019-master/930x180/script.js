...
function politeInit() {
    ...
    $(function() {
        ...
        var banner_elements = [
            spiderbro, bg, dracula1, dracula2, dracula3, bat1, bat2, pumpkins
        ];
        ...
        function animate_banner() {
            ...
            mytl
                ...
                .set(spiderbro, { opacity: 1 }, "start+=1.5")
                .from(spiderbro, .75, { x: -spiderSlideWidth, ease: Power1.easeOut }, "start+=1.5")
            ...
            .add(hoverBatLeft(bat1), "start+=2.25")
                ...
                .add(slideVertical(dracula1, "bot"), "start+=3")
                .add(slideVertical(dracula2, "bot"), "start+=5")
                .add(slideVertical(dracula3, "top"), "start+=7")
            if (loops < max_loops) {
                mytl
