...
function politeInit() {
  ...
  $(function () {
    ...
    function setupFlare() {
      ...
      console.log(lensFlareCanvas);

      function lensGenerated() {
        lensFlareCanvas.play(970, 180, 580, 150, 7);
      }
    };
    ...
    function animate_banner() {
      ...
      mytl.to(overlay, 0.35, { opacity: 0 }, "start+=0")
        .fromTo(bg, 9, { scale: 1.1, force3D: true, z: 0.1, rotationZ: 0.01, ease: Power0.easeNone }, { scale: 1 }, "start+=0")
