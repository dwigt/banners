...
$(function(){
	...
	function animate_banner(){
	    ...
	    mytl = new TimelineMax({delay:0});
			...
			.staggerFrom([splash, logo], 0.5, {y: -5, autoAlpha: 0, ease: Power1.easeOut}, 0.25, "scene1+=1.45")
			.to(t1, 0.5, {y: -5, autoAlpha: 0, ease: Power1.easeOut}, "scene1+=5")
			.from(t2, 0.5, {y: -5, autoAlpha: 0, ease: Power1.easeOut}, "scene1+=5.5")
	    ;
