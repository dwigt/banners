...
$(function() {
    ...
    function politeInit() {
        ...
        function animate_banner() {
            ...
            mytl
                .staggerFrom([text1Scene1, text2Scene1, text3Scene1], 0.5, { alpha: 0, x: -20, ease: Back.easeOut }, 0.25, "scene1")

            .from(scene2, 0.5, { alpha: 0, ease: Back.easeOut }, "scene2+=3")
                .staggerFrom([text1Scene2, text2Scene2], 0.5, { alpha: 0, x: -20, ease: Back.easeOut }, 0.25, "scene2+=3.5")

            .from(scene3, 0.5, { alpha: 0 }, "scene3+=3")
                .staggerFrom([text2Scene3, text3Scene3, text4Scene3, smylieKaufman], 0.5, { alpha: 0, x: -20, ease: Back.easeOut }, 0.25, "scene3+=3.5")
