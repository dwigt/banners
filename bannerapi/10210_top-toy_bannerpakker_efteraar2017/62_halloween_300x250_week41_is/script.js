...
$(function(){
	...
	function animate_banner(){
	    ...
	    mytl.from(['#t1','#price'],0.4,{opacity:0, ease:Power2.easeOut})
	    	...
	    	.to(['#hand1','#costume3','#price','#t1'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	...
	    	.from(['#hand1','#costume5'],0.4,{opacity:0,scale:0.8, ease:Power2.easeOut},"-=.25")
	    	.to(['#t3','#costume5','#logo','#hand1'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	.from(['#t4','#hand2','#last_hand'],0.4,{opacity:0, ease:Power2.easeOut})
