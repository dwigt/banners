...
$(function(){
	...
	function animate_banner(){
	   ...
	   mytl.from(['#t1','#price'],0.4,{opacity:0, ease:Power2.easeOut})
	    	.from(['#costume1','#hand1','#hand2'],0.4,{opacity:0,scale:0.8, ease:Power2.easeOut},"-=.25")
	    	...
	    	.to(['#hand1','#hand2','#costume3','#price','#t1'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	...
	    	.to(['#hand1','#hand2'],0.4,{opacity:1,scale:1, ease:Power2.easeOut},"-=.4")
	    	.to(['#t3','#costume5','#logo','#hand1','#hand2'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	.from(['#t4','#hand3','#hand4'],0.4,{opacity:0, ease:Power2.easeOut})
