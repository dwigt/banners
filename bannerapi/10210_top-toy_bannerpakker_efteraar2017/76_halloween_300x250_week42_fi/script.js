...
$(function(){
	...
	function animate_banner(){
	    ...
	    mytl.from(['#t1'],0.4,{opacity:0, ease:Power2.easeOut})
	    	.from(['#hand1'],0.4,{opacity:0,scale:0.8, ease:Power2.easeOut},"-=.25")
	    	.to(['#hand1','#t1'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	...
	    	.to(['#price','#costume2'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	...
	    	.to(['#t3','#costume4','#logo'],0.4,{opacity:0, ease:Power2.easeOut},"+=1.9")
	    	.from(['#t4','#last_hand','#slime'],0.4,{opacity:0, ease:Power2.easeOut})
