    ...
    function politeInit() {
        ...
        function animate_banner() {
            ...
            mytl
                ...
                .staggerFrom([text1Scene2, text2Scene2, text3Scene2, bigText, cta], 0.25, { alpha: 0, x: 20, ease: Power0.easeOut }, 0.25, "scene1+=1.5")

        

            if (loops < max_loops) {
                mytl
                    .to([text1Scene2, text2Scene2, text3Scene2, bigText, cta, logoBig], 0.5, { alpha: 0 }, "scene1+=4.5")
