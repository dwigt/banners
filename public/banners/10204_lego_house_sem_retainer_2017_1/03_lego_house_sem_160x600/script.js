...
$(function(){
	...
	function animate_banner(){
	    ...
	    scene1 = new TimelineMax({delay:0});
			...
			.from(fish1, 1, {x: -200, rotation: 25, ease: Power1.easeOut}, 0.25, "scene1Start+=2")
			// .from(lights, 5,{alpha:0.3 ,ease: RoughEase.ease.config({ strength: 1, points: 8, taper: "none", randomize: false, clamp: true})},"scene1Start+=0")
			// .to(lights, 1, {alpha:0.3, ease: RoughEase.ease.config({ strength: 1, points: 1, taper: "none", randomize: false, clamp: true})},"scene1Start+=6")			
			.staggerFrom([t1, t2], 0.5, {y:-5, opacity: 0, ease: Power1.easeOut}, 0.25, "scene1Start+=0.2")
			.from(fish2, 1, {x: 200, rotation: 25,ease: Power1.easeOut}, "scene1Start+=1")
		...
		if( loops < max_loops ){
			...
			.to([fish1, fish2], 1, {alpha: 0, ease: Power1.easeOut}, "scene1Start+=9")
