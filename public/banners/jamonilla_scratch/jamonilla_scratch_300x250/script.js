...
function politeInit() {
    ...
    var clip_swiper_left_to_right = "rect(0px " + "300px " + "250px " + "300px)";
    var clip_swiper_right_to_left = "rect(0px " + "0px " + "250px " + "0px)";
    var reset = "rect(0px 300px 250px 0px)";
    ...
    function animate_banner() {
      ...
      function scratch() {
        ...
        .fromTo('.coin', 1, {left: 300, top: 50}, { left: 43, top: 174, ease: "none" }, "+=0")

        .to('.clip__swiper1', { duration: scratch_duration, clip: clip_swiper_left_to_right, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: 252, top: 66, ease: "none" }, "-=" + scratch_duration)

        .to('.clip__swiper2', { duration: scratch_duration, clip: clip_swiper_right_to_left, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: -33, top: 125, ease: "none" }, "-=" + scratch_duration)

        .to('.clip__swiper3', { duration: scratch_duration, clip: clip_swiper_left_to_right, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: 216, top: -48, ease: "none" }, "-=" + scratch_duration)

        .to('.clip__swiper4', { duration: scratch_duration, clip: clip_swiper_right_to_left, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: -26, top: 2, ease: "none" }, "-=" + scratch_duration)
        
        .to('.clip__swiper5', { duration: scratch_duration, clip: clip_swiper_left_to_right, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: 87, top: -100, ease: "none" }, "-=" + scratch_duration)
      }
