...
function politeInit() {
    ...
    var clip_swiper_left_to_right = "rect(0px " + "930px " + "180px " + "930px)";
    var clip_swiper_right_to_left = "rect(0px " + "0px " + "180px " + "0px)";
    var reset = "rect(0px 930px 180px 0px)"
    ...
    function animate_banner() {
      ...
      function scratch() {
        ...
        .fromTo('.coin', 1,{left: -150, top: 60}, { left: -11, top: 79, ease: "none" }, "+=0")

        .to('.clip__swiper1', { duration: scratch_duration, clip: clip_swiper_left_to_right, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left: 307, top: -150, ease: "none" }, "-=" + scratch_duration)
        ...
        .to('.coin', { duration: scratch_duration, left: 460, top: -80, ease: "none" }, "-=" + scratch_duration)
        ...
        .to('.coin', { duration: scratch_duration, left: 750, top: 250, ease: "none" }, "-=" + scratch_duration)

        .to('.clip__swiper9', { duration: scratch_duration, clip: clip_swiper_left_to_right, ease: "none" }, "+=0")
        .to('.coin', { duration: scratch_duration, left:940, top: 54, ease: "none" }, "-=" + (scratch_duration - 0.15))
      }
