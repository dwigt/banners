...
function politeInit() {
    ...
    var clip_swiper_left_to_right = "rect(0px " + "300px " + "600px " + "300px)";
    var clip_swiper_right_to_left = "rect(0px " + "0px " + "600px " + "0px)";
    var reset = "rect(0px 300px 600px 0px)"
