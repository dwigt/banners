...
function politeInit() {
    ...
    function animate_banner() {
      ...
      mytl
         ...
         .fromTo('.bg1', {scale: 1}, { duration: 3.7, scale: 1, x: -30, y: -12, ease: "power0.easeNone" }, "start")
         ...
         .fromTo('.bg2',  {scale: 1}, { duration: 3.7, scale: 1, x: -30, y: 25, ease: "power0.easeNone" }, "start+=3.7")
         ...
         .to('.t1_1', {duration: 1, x: -300,  ease: "power2.in" }, "start+=11.25")
         .to('.t1_2', {duration: 1, x: 300,  ease: "power2.in" }, "start+=11.25")
         .to(['.bg2'], {duration: .5, opacity: 0, ease: "power2.in" }, "start+=12.25")
         .from('.p1', {duration: .65, scale: 0, ease: "back.out(1.4)"}, "start+=12.5")
         .from('.t2_1',  {duration: 1.5, y: -250,  ease: "power2.out" }, "start+=12.25")
         .from('.t2_2',{duration: 1.5, y: 250,  ease: "power2.out" }, "start+=12.25")
      if (loops < max_loops) {
        mytl.to(
			'.overlay',
