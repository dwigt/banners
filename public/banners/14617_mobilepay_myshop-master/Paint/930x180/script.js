...
$(function() {
    ...
    var banner_elements = [
        t1, t2, scene1, scene2,scene3,  swiper_chevron, clip, swiper_bg, clip__swipertext, cta
    ];
    ...
    var swipeWidth = clip_swiper_width - $("#swiper__chevron").width();
    ...
    function animate_banner() {
        ...
        .to(scene1, scenetransitionTiming, {y: -bannerHeight, ease: Power2.EaseOut}, "start+=3")
        
        .from(scene2, scenetransitionTiming, {y: bannerHeight, ease: Power2.EaseOut}, "start+=3")

        .to(clip__swipertext, swiperTime, { clip: clip_swiper_end, ease: Power4.easeOut }, "+=.3")
        .to(swiper_chevron, swiperTime, { x: swipeWidth, ease: Power4.easeOut }, "-=" + swiperTime)

        .to(scene2, scenetransitionTiming, {y: -bannerHeight, ease: Power2.EaseOut}, "+=.24")
        .from(scene3, scenetransitionTiming, {y: bannerHeight, ease: Power2.EaseOut}, "-=" + scenetransitionTiming)
        ...
        if (loops < max_loops) {
            ...
            .set(scene1, {y: bannerHeight}, "+=0")
            .to(scene1, scenetransitionTiming, {y: 0}, "+=0")
            .to(scene3, scenetransitionTiming, {y: -(bannerHeight)}, "-=" + scenetransitionTiming)
