...
function politeInit() {
	...
	$(function () {
		...
		function animate_banner() {
			...
			// mytl.timeScale(0.2); 
			mytl
			.to(p1, {duration: "3.333", y: -13, ease: "sine.inOut", repeat: 3, yoyo: true}, "start")
			.to(light1, {duration: "0.5", y: "100%"}, "start+=.5")
			.from(t1, {duration: "0.3", autoAlpha: 0}, "start+=.55")
			.from(t3, {duration: "0.2", autoAlpha: 0}, "start+=.5")
			.to(light2, {duration: ".5", y: "100%"}, "start+=2.5")
			...
			if (loops < max_loops) {
				mytl
				.set(light2, {y: "0%"}, "start+=3.75")
				.to(light2, {duration: ".5", y: "100%"}, "start+=5")
				.to(t2, {duration: "0.3", autoAlpha: 0}, "start+=5")
				.to(t1, {duration: "0.3", autoAlpha: 1}, "start+=5")
				.set(light2, {y: "0%"}, "start+=6")
				.to(light2, {duration: ".5", y: "100%"}, "start+=7.5")
