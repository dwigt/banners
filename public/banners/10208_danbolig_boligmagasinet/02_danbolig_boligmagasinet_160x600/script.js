	...
	function on_page_load_complete(){
		...
		function animate_banner(){
		    ...
		    mytl = new TimelineMax({delay:0.5});
				...
				.from(txt1, 1.5, {alpha: 0, y:-5, ease:Power4.easeOut},"start+=0.5")

				.from(btn,1.75, {alpha:0, y: -5, ease:Power4.easeOut}, "start+=1")
				.from(logo, 1.75, {alpha: 0, y:-5, ease:Power4.easeOut},"start+=1.25")
