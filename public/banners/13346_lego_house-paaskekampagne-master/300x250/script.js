...
function politeInit() {
    ...
    $(function() {
        ...
        var backgroundAnimationHeight = -56
        ...
        function animate_banner() {
            ...
            .to(bg1, 7, {x: backgroundAnimationHeight, ease: Power0.easeNone}, "start")
            ...
            .to(bg2, 7, {x: backgroundAnimationHeight, ease: Power1.easeOut}, "start+=7")
