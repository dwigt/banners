...
reset_banner();
	...
	function animate_scene1(next){
	    ...
	    scene1 = new TimelineMax({delay:0});
			scene1
			.from(logo2, 0.7, {x: 320, ease: Power3.easeOut}, "scene1+=0")
			.from(logo1, 0.7, {x: -320, ease: Power3.easeOut}, "scene1+=0")
			.from(motiv1, 1, {x:320, ease:  Power3.easeOut}, "scene1+=0.7")
			.to(logo1, 0.5, {x: 320, ease: Power3.easeIn}, "scene1+=4")
			.to(logo2, 0.5, { x: 320, ease: Power3.easeIn}, "scene1+=4")
			.to(motiv1, 0.5, { x:-320, ease: Power3.easeIn}, "scene1+=4")
			if(!next) {
	...
	function animate_scene2(next){
		...
		TweenMax.set($("#scene3"), {alpha:0});
			...
			.from(txt1, 0.7, {x: -320, ease: Power3.easeOut}, "scene2+=0.8")
			.from(logo2sc2, 0.7, {x: 320, ease: Power3.easeOut}, "scene2+=0.8")
			.to(txt1, 1.1, {alpha:0,ease: Back.easeOut.config(1)}, "scene2+=3")
			.to(motiv2, 1, {y:-640, ease: Power1.easeIn}, "scene2+=3")
			.to(logo2sc2, 1.1, {alpha:0, ease: Power3.easeOut}, "scene2+=3")
			.to(bg1sc2, 1, {y:-320,ease: Power1.easeIn}, "scene2+=3")
			.from(bg2sc2, 1, {y:320, ease: Power1.easeIn}, "scene2+=3")
			
			if(!next) {
				scene2.set(banner, {delay:0});
				;
				scene2.set(banner, {delay:1, onComplete:next_scene, onCompleteParams:[2]}, "end");
			}
...
function animate_scene3(next){
		...
		TweenMax.set($("#scene2"), {alpha:0});
			...
			.set(logo3sc3, {scale: 0.8, transformOrigin:"0% 0%"}, "scene3+=0")
			.from(logo3sc3, 0.7, {alpha: 0, ease: Power3.easeOut}, "scene3+=1")
