...
reset_banner();
	...
	function animate_scene1(next){
	    ...
	    scene1 = new TimelineMax({delay:0});
			...
			.from(motiv1, 1, {y:-160, ease:  Power3.easeOut}, "scene1+=0.7")
			.to(logo1, 0.5, {x: -320, ease: Power3.easeIn}, "scene1+=4")
			.to(logo2, 0.5, { x: 320, ease: Power3.easeIn}, "scene1+=4")
			.to(motiv1, 0.5, { y:-160, ease: Power3.easeIn}, "scene1+=4")
			if(!next) {
	...
	function animate_scene2(next){
		...
		TweenMax.set($("#scene3"), {alpha:0});
			...
			scene2
			.from(motiv2, 1, {y:160, ease: Power1.easeOut}, "scene2+=0")
			...
			.to(motiv2, 1, {y:-320, ease: Power1.easeIn}, "scene2+=3")
			.to(logo2sc2, 1.1, {alpha:0, ease: Power3.easeOut}, "scene2+=3")
			.to(bg1sc2, 1, {y:-160,ease: Power1.easeIn}, "scene2+=3")
			.from(bg2sc2, 1, {y:160, ease: Power1.easeIn}, "scene2+=3")
...
function animate_scene3(next){
		...
		TweenMax.set($("#scene2"), {alpha:0});
			...
			.from(logo3sc3, 0.7, {x: 320, ease: Power3.easeOut}, "scene3+=1")
