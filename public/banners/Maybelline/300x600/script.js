...
lash_logo						= $("#lash_logo");
		...
		function animate_banner() {
			...
			.from(flower_clipMask, 1, {x: "100%",  transformOrigin: "0 600px", ease: Power0.easeNone}, "flower+=0")
			.from(flower, 1,{ x: "-100%", transformOrigin: "0 600px", ease: Power0.easeNone}, "flower+=0")
			.to(brush, 0.4, {rotation: -90, transformOrigin: "bottom center", ease: Power0.easeNone}, "flower+=0.80")
			.to(brush, 0.4, {rotation: -180, transformOrigin: "bottom center", ease: Power0.easeNone}, "+=0")
    	...
    	.to([lash_logo, t1l1, t1l2], .35, {opacity: 0}, "-=.5")
			.from(pink_brush, .75, {opacity: 0, ease: Power1.easeOut}, "-=0.35")
