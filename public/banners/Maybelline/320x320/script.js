...
lash_logo						= $("#lash_logo");
		var banner_elements = [
			flower_clipMask, flower, brush, text_clipMask, text_wrapper, pink_brush, t1l1, t1l2, t2l1, t2l2, cta, lash_logo
		];
		...
		function animate_banner() {
			...
			.to(flower_clipMask, .5, { rotation: 0, transformOrigin: "0 600px", ease: Power0.easeNone}, "flower+=0.1")
			.from(flower, .5,{ rotation: -90, transformOrigin: "0 600px", ease: Power0.easeNone}, "flower+=0.1")
			.to(brush, .5, {rotation: -90, transformOrigin: "bottom left", ease: Power0.easeNone}, "flower+=0.31")
			.to(brush, .5, {rotation: -180, transformOrigin: "bottom left", ease: Power0.easeNone}, "+=0")
			
			.to(text_clipMask, 1.5, {rotation: -90, transformOrigin: "bottom right"}, "-=0.9")
			.to(text_wrapper, 1.5, {rotation: 90, transformOrigin: "bottom right"}, "-=1.5")
			.to(lash_logo, .75, {opacity: 0}, "-=1.185")
			.from(pink_brush, .75, {opacity: 0, ease: Power1.easeOut}, "-=1")
			.from(t2l1, .5, {opacity: 0, ease: Power1.easeOut}, "-=.75")
			.from(t2l2, .5, {opacity: 0, ease: Power1.easeOut}, "-=.37")
