...
$(function() {
    ...
    var piggybank = $("#piggybank"),
        ...
        coin2 = $("#coin2"),
        coin3 = $("#coin3"),
        t1 = new SplitText("#t1", { type: "chars" }),
    ...
    var clip_swiper_begin = "rect(0px " + clip_swiper_width + "px " + clip_swiper_height + "px " + "28px)";
    ...
    function animate_banner() {
        ...
        .staggerFrom(t1.chars, .75, { opacity: 0, y: 5, ease: Power1.easeOut }, 0.025, "-=1")
            ...
            .to(t1.chars, .75, { x: -191, y: -11, ease: Power1.easeOut }, "-=.75")
        ...
        .to(clip, .75, { clip: clip_swiper_begin, ease: Power1.easeOut }, "+=0")
            ...
            .from(swiper_bg, .75, { x: -(clip_swiper_width), ease: Power1.easeOut }, "-=.75")

        .to(clip__swipertext, .75, { clip: clip_swiper_end }, "+=1")
            .to(swiper_chevron, .75, { x: swipeWidth }, "-=.75")
    ...
    function reset_banner() {
        ...
        TweenMax.set([t1.chars, t2.chars, t3.chars], { x: 0, y: 0, opacity: 1 })
