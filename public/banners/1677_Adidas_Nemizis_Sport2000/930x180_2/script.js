	...
	function on_page_load_complete(){
		...
		function animate_banner(){
			...
			if(loops < max_loops){
				...
				.from([txt1, logo], 1, {alpha:0, ease: Power1.easeOut}, "scene1+=1.5")
				.to([sko1, sko2], 0.5, {alpha:0, ease: Power1.easeOut}, "scene1+=8.5")
				.to(svgImage,  0.5, {alpha: "0"}, "scene1+=8.5")
				.to([txt1, txt2], 0.5, {alpha:0, ease: Power1.easeOut}, "scene1+=8.5")
