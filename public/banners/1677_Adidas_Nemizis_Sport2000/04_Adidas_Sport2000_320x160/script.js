	...
	function on_page_load_complete(){
		...
		function animate_banner(){
			...
			if(loops < max_loops){
				...
				.to(txt1, 0.5, {alpha:0, ease: Power1.easeOut}, "scene1+=9.5")
			...
			if(loops === max_loops ){
				scene1
				.staggerFrom([sko1, sko2], 1, {alpha:0, ease:Sine.easeOut}, 0.6, "scene1")
				.to(svgMaskImg1,  0.2, {morphSVG:svgMaskImg2}, "scene1+=0.2")
				.to(svgMaskImg1,  0.2, {morphSVG:svgMaskImg3}, "scene1+=0.4")
				.to(svgMaskImg1,  0.2, {morphSVG:svgMaskImg4}, "scene1+=0.6")
				.to(svgMaskImg1,  0.2, {morphSVG:svgMaskImg5}, "scene1+=0.8")
				.from(txt1, 1, {alpha:0, ease: Power1.easeOut}, "scene1+=1.5")
				.to(txt1, 0.5, {alpha:0, ease: Power1.easeIn}, "scene1+=4")
				.from(logo, 1, {alpha:0, ease: Power1.easeOut}, "scene1+=5")
				.from(btn, 0.2, {scale:"0", ease: Power1.easeOut}, "scene1+=5.5")
