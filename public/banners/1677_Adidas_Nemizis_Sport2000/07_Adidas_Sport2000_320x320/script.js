	...
	function on_page_load_complete(){
		...
		function animate_banner(){
			...
			if(loops < max_loops){
				...
				.from(txt1, 1, {alpha:0, ease: Power1.easeOut}, "scene1+=1.5")
				.to(txt1, 0.5, {alpha:0, ease: Power1.easeIn}, "scene1+=3")
				.from(txt2, 1, {alpha:0, ease: Power1.easeOut}, "scene1+=3.5")
				.to(txt2, 0.5, {alpha:0, ease: Power1.easeIn}, "scene1+=5")
				.from(logo, 1, {alpha:0, ease: Power1.easeOut}, "scene1+=5.5")
				.from(btn, 0.2, {scale:"0", ease: Power1.easeOut}, "scene1+=6")
				.to(btn, 0.3, {scale: "1.1",ease: Power1.easeOut}, "scene1+=6.5")
