    ...
    function politeInit() {
        ...
        function animate_banner() {
            ...
            .from(scene2, 0.5, { alpha: 0, ease: Back.easeOut }, "scene2")
                .staggerFrom([text1Scene2, text2Scene2, text3Scene2], 0.2, { alpha: 0, x: 20, ease: Power0.easeOut }, 0.25, "scene2+=0.5")
                .from(text4Scene2, 0.5, { alpha: 0, x: 20 }, "scene2+=1.25")
