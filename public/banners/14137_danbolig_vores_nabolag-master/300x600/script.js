...
function politeInit() {
    ...
    var pins =  ['.favorit1', '.favoritpin4','.favorit2','.favoritpin2' ,'.favorit4', '.favoritpin1',  '.favorit3',  '.favoritpin3']
    var mytl;
    var loops = 0;
    var max_loops = 2;
    ...
    function animate_banner() {
      ...
      function scene1() {
        var houseArr = ['.house2','.house6','.house5','.house1', '.house3', '.house4']
      ...
      function scene3() {
        ...
        .from('.phone', {duration: .5, x: '300px', ease: "power1.out"}, '+=.1')
        return scene3
      }
