	...
	function on_page_load_complete(){
		...
		function animate_banner(){
			...
			if(loops < max_loops){
		    	...
		    	.from(line1, 1, {x:621, ease: Expo.easeOut}, "scene1+=1")
		    	.from(line2, 1, {x:-621, ease: Expo.easeOut}, "scene1+=1")
		    	.from(sko1, 1.1, {x:-621, ease: Expo.EaseOut}, "scene1+=1")
		    	.from(sko2, 1.1, {x:621, ease: Expo.EaseOut}, "scene1+=1")
		    	...
		    	.to(line1, 1, {x:621, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(line2, 1, {x:-621, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(sko1, 1.1, {x:-621, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(sko2, 1.1, {x:621, ease: Expo.EaseIn}, "scene1+=12")
