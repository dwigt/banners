	...
	function on_page_load_complete(){
		...
		function animate_banner(){
			...
			if(loops < max_loops){
		    	...
		    	.from(line1, 1, {x:735, ease: Expo.easeOut}, "scene1+=1")
		    	.from(line2, 1, {x:-735, ease: Expo.easeOut}, "scene1+=1")
		    	.from(sko1, 1.1, {x:-735, ease: Expo.EaseOut}, "scene1+=1")
		    	.from(sko2, 1.1, {x:735, ease: Expo.EaseOut}, "scene1+=1")
		    	...
		    	.to(line1, 1, {x:735, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(line2, 1, {x:-735, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(sko1, 1.1, {x:-735, ease: Expo.EaseIn}, "scene1+=12")
		    	.to(sko2, 1.1, {x:735, ease: Expo.EaseIn}, "scene1+=12")
			...
			if(loops === max_loops ){
				scene1
		    	.from(speed, 1.5, {alpha:0, ease: Power1.EaseOut})
		    	.from(line1, 1, {x:1525, ease: Expo.easeOut}, "scene1+=1")
		    	.from(line2, 1, {x:-500, ease: Expo.easeOut}, "scene1+=1")
		    	.from(sko1, 1.1, {x:-500, ease: Expo.EaseOut}, "scene1+=1")
		    	.from(sko2, 1.1, {x:1525, ease: Expo.EaseOut}, "scene1+=1")
		    	.from(player, 1, {alpha:0, ease: Power1.EaseOut}, "scene1+=2")
				.from(logos, 1, {alpha:0, ease: Power1.EaseOut}, "scene1+=2.5")
		    	.to(speed, 0.5, {alpha:0, ease: Power1.EaseIn}, "scene1+=3.5")
		    	.staggerFrom([txt1, btn], 0.5, {scale:0, alpha:0, ease: Back.easeOut.config(1.7)}, 0.25, "scene1+=4")
